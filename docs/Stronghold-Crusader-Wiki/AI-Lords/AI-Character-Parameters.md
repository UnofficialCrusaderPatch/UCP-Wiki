...
**Requirements:** Crusader or Crusader Extreme 1.41, framework >=3.0.4, frontend >=1.0.16, and `aicloader >=1.1.0`. Enable the module, then **Troop settings** and **Allow AIC settings to override these defaults** under **AI → AIV Troop Behaviour**. The position-loading fix alone does not enable the extra behavior fields. AI Swapper is optional.
